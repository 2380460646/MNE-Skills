...
**URL:** https://mne.tools/mne-connectivity/stable/install.html
...
We require that you use Python 3.9 or higher. You may choose to install mne-connectivity via pip, or conda.
